    ...
    <>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white shadow-lg py-4 px-6 animate-fadeIn">
          <Login />
          <a className="block py-3 text-blue-800 hover:text-blue-600 font-medium rounded-lg transition-all duration-300 hover:bg-blue-50 mt-2">
            <Register />
          </a>
        </div>
      )}
      ...
      <footer className="bg-gray-800 text-white py-8 px-6 text-center">
        <p>© {new Date().getFullYear()} OKU Transport. All rights reserved.</p>
      </footer>
    </>
  );
};
